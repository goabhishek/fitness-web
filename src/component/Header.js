  ...
  return (
    <Box>
      ...
      >
        ...
        <Flex flex={{ base: 1, md: 'auto' }} ml={{ base: -4 }} display={{ base: 'flex', md: 'none' }}>
          <IconButton
            onClick={onToggle}
        ...
        >
          <AppButton
            ...
            name='Download ios store'
            link='https://itunes.apple.com/us/app/all-of-the-lights/id959389722?mt=8'
          />
          <AppButton
            src='https://res.cloudinary.com/mabhi8251/image/upload/v1658299971/Gloitel-fitness/google-play_watgwk.png'
            name='Get on Goole Play'
            link='https://itunes.apple.com/us/app/all-of-the-lights/id959389722?mt=8'
          />
        </Stack>
        <Stack
...
const MobileNav = () => {
  return (
    <Stack bg={useColorModeValue('white', 'gray.1000')} p={20} zIndex={10} position={'fixed'} display={{ md: 'none' }}>
      {NAV_ITEMS.map((navItem) => (
